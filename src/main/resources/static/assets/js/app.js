class App {
    ...
    static BASE_URL_CLOUD_IMAGE = "https://res.cloudinary.com/dzc1oww1y/image/upload";
    static BASE_URL_CLOUD_VIDEO = "https://res.cloudinary.com/dzc1oww1y/video/upload";
